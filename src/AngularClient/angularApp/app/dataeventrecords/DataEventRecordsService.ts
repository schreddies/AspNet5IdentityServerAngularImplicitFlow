...
export class DataEventRecordsService {
    ...
    constructor(private _http: Http, private config: ConfigService, private _securityService: OidcSecurityService) {
        this.actionUrl = `${config.apiServer}api/DataEventRecords/`;
    }
